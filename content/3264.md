...
The last case is called a degenerate conic, and the two lines are allowed to be equal (in which case we speak of a double line).
...
0.43x^2 &-&  0.51xy&+&   0.43  y^2 &+&  2.56x&-&  4.27y&+&  10.0\\\\[0.5em]
0.08x^2&&  &+&   0.33 y^2&-& 1.82x&+&   1.32y &+& 10.0\\\\[0.5em]
  0.11x^2&+&   0.08xy  &+& 0.11y^2 &-& 1.76x&-&  1.76y &+& 10.0\\\\[0.5em]
 2.5x^2 && &+&  0.4y^2 &-& 10.0x &+& 3.2y&+& 6.4\\\\[0.5em]
  0.18x^2 &-& 0.61xy &+&  0.18y^2 &+&  0.73x &+&  0.73y &+&  10.0
\end{array}
}
$$
</figcaption>
...
Steiner himself claimed in 1848 that there are at most 7776 conics tangent to 5 given conics.
He phrased his problem as that of solving five equations
of degree six on the 5-dimensional space $\mathbb{P}^5$.
...
we can use the proposed construction to find an explicit instance for which there are 3264 real conics.
...
It looks like the arrangement consists of 5 blue lines, rather than 5 blue conics. The next picture clarifies the situtation.
